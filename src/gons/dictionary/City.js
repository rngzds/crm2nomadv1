...
const City = ({ onBack }) => {
  return (
    <div data-layer="City - select" className="CitySelect" style={{width: 393, height: 852, paddingBottom: 16, background: 'white', overflow: 'hidden', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex'}}>
