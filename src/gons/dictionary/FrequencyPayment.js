  ...
  <div data-layer="Payment procedure" className="PaymentProcedure" style={{flex: '1 1 0', height: 982, background: 'white', overflow: 'hidden', borderRight: '1px #F8E8E8 solid', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'inline-flex'}}>
    <div data-layer="SubHeader" data-type="Creating an order" className="Subheader" style={{alignSelf: 'stretch', background: 'white', overflow: 'hidden', borderBottom: '1px #F8E8E8 solid', justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex'}}>
      <div data-layer="Title" className="Title" style={{flex: '1 1 0', height: 85, paddingLeft: 20, justifyContent: 'center', alignItems: 'center', gap: 10, display: 'flex'}}>
        ...
        <div data-layer="Save button" data-state="pressed" className="SaveButton" onClick={() => {
          if (onSelect && selectedValue) {
            onSelect(getDisplayName(selectedValue));
          }
          if (onBack) {
            onBack();
          }
    ...
    <div data-layer="Fields List" className="FieldsList" style={{alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'flex'}}>
      <div data-layer="InputContainerRadioButton" data-state={selectedValue === 'once' ? "pressed" : "not_pressed"} className="Inputcontainerradiobutton" onClick={() => setSelectedValue('once')} style={{alignSelf: 'stretch', height: 85, paddingLeft: 20, background: 'white', overflow: 'hidden', borderBottom: '1px #F8E8E8 solid', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex', cursor: 'pointer'}}>
        ...
        <div data-layer="Radiobutton container" className="RadiobuttonContainer" style={{width: 85, height: 85, position: 'relative', background: '#FBF9F9', overflow: 'hidden'}}>
          <div data-svg-wrapper data-layer={selectedValue === 'once' ? "Ellipse-on" : "Ellipse-off"} className={selectedValue === 'once' ? "EllipseOn" : "EllipseOff"} style={{left: 35, top: 36, position: 'absolute'}}>
      ...
      <div data-layer="InputContainerRadioButton" data-state={selectedValue === 'monthly' ? "pressed" : "not_pressed"} className="Inputcontainerradiobutton" onClick={() => setSelectedValue('monthly')} style={{alignSelf: 'stretch', height: 85, paddingLeft: 20, background: 'white', overflow: 'hidden', borderBottom: '1px #F8E8E8 solid', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex', cursor: 'pointer'}}>
        <div data-layer="Text container" className="TextContainer" style={{flex: '1 1 0', paddingTop: 20, paddingBottom: 20, overflow: 'hidden', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'flex'}}>
        ...
        <div data-layer="Radiobutton container" className="RadiobuttonContainer" style={{width: 85, height: 85, position: 'relative', background: '#FBF9F9', overflow: 'hidden'}}>
          <div data-svg-wrapper data-layer={selectedValue === 'monthly' ? "Ellipse-on" : "Ellipse-off"} className={selectedValue === 'monthly' ? "EllipseOn" : "EllipseOff"} style={{left: 35, top: 36, position: 'absolute'}}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div data-layer="InputContainerRadioButton" data-state={selectedValue === 'quarterly' ? "pressed" : "not_pressed"} className="Inputcontainerradiobutton" onClick={() => setSelectedValue('quarterly')} style={{alignSelf: 'stretch', height: 85, paddingLeft: 20, background: 'white', overflow: 'hidden', borderBottom: '1px #F8E8E8 solid', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex', cursor: 'pointer'}}>
        <div data-layer="Text container" className="TextContainer" style={{flex: '1 1 0', paddingTop: 20, paddingBottom: 20, overflow: 'hidden', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'flex'}}>
        ...
        <div data-layer="Radiobutton container" className="RadiobuttonContainer" style={{width: 85, height: 85, position: 'relative', background: '#FBF9F9', overflow: 'hidden'}}>
          <div data-svg-wrapper data-layer={selectedValue === 'quarterly' ? "Ellipse-on" : "Ellipse-off"} className={selectedValue === 'quarterly' ? "EllipseOn" : "EllipseOff"} style={{left: 35, top: 36, position: 'absolute'}}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div data-layer="InputContainerRadioButton" data-state={selectedValue === 'halfyearly' ? "pressed" : "not_pressed"} className="Inputcontainerradiobutton" onClick={() => setSelectedValue('halfyearly')} style={{alignSelf: 'stretch', height: 85, paddingLeft: 20, background: 'white', overflow: 'hidden', borderBottom: '1px #F8E8E8 solid', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex', cursor: 'pointer'}}>
        <div data-layer="Text container" className="TextContainer" style={{flex: '1 1 0', paddingTop: 20, paddingBottom: 20, overflow: 'hidden', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'flex'}}>
        ...
        <div data-layer="Radiobutton container" className="RadiobuttonContainer" style={{width: 85, height: 85, position: 'relative', background: '#FBF9F9', overflow: 'hidden'}}>
          <div data-svg-wrapper data-layer={selectedValue === 'halfyearly' ? "Ellipse-on" : "Ellipse-off"} className={selectedValue === 'halfyearly' ? "EllipseOn" : "EllipseOff"} style={{left: 35, top: 36, position: 'absolute'}}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            {selectedValue === 'halfyearly' ? (
              <circle cx="7" cy="7" r="6.5" fill="black" stroke="black"/>
            ) : (
              <circle cx="7" cy="7" r="6.5" stroke="black"/>
            )}
