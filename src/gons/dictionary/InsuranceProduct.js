...
const InsuranceProduct = ({ onBack, onSelect }) => {
  ...
  const getDisplayName = (value) => {
    const nameMap = {
      'business_150': '«CEHIM» Бизнес 150',
      'business_200': '«CEHIM» Бизнес 200',
      'business_250': '«CEHIM» Бизнес 250'
    };
  ...
  <div data-layer="Insurance program" className="InsuranceProgram" style={{flex: '1 1 0', height: 982, background: 'white', overflow: 'hidden', borderRight: '1px #F8E8E8 solid', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'inline-flex'}}>
    ...
    <div data-layer="Fields List" className="FieldsList" style={{alignSelf: 'stretch', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', display: 'flex'}}>
      <div data-layer="InputContainerRadioButton" data-state={selectedValue === 'business_150' ? "pressed" : "not_pressed"} className="Inputcontainerradiobutton" onClick={() => setSelectedValue('business_150')} style={{alignSelf: 'stretch', height: 85, paddingLeft: 20, background: 'white', overflow: 'hidden', borderBottom: '1px #F8E8E8 solid', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex', cursor: 'pointer'}}>
        ...
        <div data-layer="Radiobutton container" className="RadiobuttonContainer" style={{width: 85, height: 85, position: 'relative', background: '#FBF9F9', overflow: 'hidden'}}>
          <div data-svg-wrapper data-layer={selectedValue === 'business_150' ? "Ellipse-on" : "Ellipse-off"} className={selectedValue === 'business_150' ? "EllipseOn" : "EllipseOff"} style={{left: 35, top: 36, position: 'absolute'}}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            {selectedValue === 'business_150' ? (
      ...
      <div data-layer="InputContainerRadioButton" data-state={selectedValue === 'business_200' ? "pressed" : "not_pressed"} className="Inputcontainerradiobutton" onClick={() => setSelectedValue('business_200')} style={{alignSelf: 'stretch', height: 85, paddingLeft: 20, background: 'white', overflow: 'hidden', borderBottom: '1px #F8E8E8 solid', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex', cursor: 'pointer'}}>
        <div data-layer="Text container" className="TextContainer" style={{flex: '1 1 0', paddingTop: 20, paddingBottom: 20, overflow: 'hidden', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'flex'}}>
        ...
        <div data-layer="Radiobutton container" className="RadiobuttonContainer" style={{width: 85, height: 85, position: 'relative', background: '#FBF9F9', overflow: 'hidden'}}>
          <div data-svg-wrapper data-layer={selectedValue === 'business_200' ? "Ellipse-on" : "Ellipse-off"} className={selectedValue === 'business_200' ? "EllipseOn" : "EllipseOff"} style={{left: 35, top: 36, position: 'absolute'}}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            {selectedValue === 'business_200' ? (
              <circle cx="7" cy="7" r="6.5" fill="black" stroke="black"/>
            ) : (
              <circle cx="7" cy="7" r="6.5" stroke="black"/>
            )}
      ...
      <div data-layer="InputContainerRadioButton" data-state={selectedValue === 'business_250' ? "pressed" : "not_pressed"} className="Inputcontainerradiobutton" onClick={() => setSelectedValue('business_250')} style={{alignSelf: 'stretch', height: 85, paddingLeft: 20, background: 'white', overflow: 'hidden', borderBottom: '1px #F8E8E8 solid', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'inline-flex', cursor: 'pointer'}}>
        <div data-layer="Text container" className="TextContainer" style={{flex: '1 1 0', paddingTop: 20, paddingBottom: 20, overflow: 'hidden', justifyContent: 'flex-start', alignItems: 'center', gap: 10, display: 'flex'}}>
        ...
        <div data-layer="Radiobutton container" className="RadiobuttonContainer" style={{width: 85, height: 85, position: 'relative', background: '#FBF9F9', overflow: 'hidden'}}>
          <div data-svg-wrapper data-layer={selectedValue === 'business_250' ? "Ellipse-on" : "Ellipse-off"} className={selectedValue === 'business_250' ? "EllipseOn" : "EllipseOff"} style={{left: 35, top: 36, position: 'absolute'}}>
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            {selectedValue === 'business_250' ? (
              <circle cx="7" cy="7" r="6.5" fill="black" stroke="black"/>
            ) : (
              <circle cx="7" cy="7" r="6.5" stroke="black"/>
            )}
