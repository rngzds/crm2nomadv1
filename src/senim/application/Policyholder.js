...
const Policyholder = ({ onBack }) => {
  ...
  // Обработчик для кнопки "Запросить данные"
  ...
  const handleSave = () => {
    ...
    console.log('Сохранение данных:', { fieldValues, dictionaryValues });
  };
  ...
  return (
    <div data-layer="Policyholder Data Received" className="PolicyholderDataReceived" style={{width: 393, height: '100vh', minHeight: '100vh', background: 'white', overflow: 'hidden', flexDirection: 'column', alignItems: 'center', display: 'inline-flex', position: 'relative'}}>
      {/* Header - фиксированный вверху */}
      <div data-layer="Header" data-show-indicator="false" data-type="Main" className="Header" style={{width: 393, height: 85, background: 'white', overflow: 'hidden', borderBottom: '1px #F8E8E8 solid', justifyContent: 'space-between', alignItems: 'center', display: 'inline-flex', position: 'fixed', top: 0, left: '50%', transform: 'translateX(-50%)', zIndex: 1000}}>
