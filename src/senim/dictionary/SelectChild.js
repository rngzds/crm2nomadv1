...
const SelectChild = ({ onBack, onSelect }) => {
  ...
  return (
    <div data-layer="Child Selection - select" className="ChildSelectionSelect" style={{width: 393, height: '100vh', minHeight: '100vh', background: 'white', overflow: 'hidden', flexDirection: 'column', alignItems: 'center', display: 'flex', position: 'relative'}}>
      {/* Fixed Header */}
